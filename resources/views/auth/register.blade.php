        ...
        <div class="auth-card card shadow-lg border-0 rounded-5">
            <div class="card-body p-5">
                ...
                <div class="position-relative mb-4 login-separator">
                    <hr>
                    <span class="position-absolute top-50 start-50 translate-middle small">Or register with email</span>
                </div>
                ...
                <form action="{{ route('register.post') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-lg">
                            <span class="input-group-text auth-input-icon"><i class="fas fa-user text-muted small"></i></span>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-lg">
                            <span class="input-group-text auth-input-icon"><i class="fas fa-envelope text-muted small"></i></span>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-lg">
                            <span class="input-group-text auth-input-icon"><i class="fas fa-phone text-muted small"></i></span>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-lg">
                            <span class="input-group-text auth-input-icon"><i class="fas fa-shield-alt text-muted small"></i></span>
